                ...
                <div className="col-lg-6 resume-card">
                    ...
                    <div className="resume-card__body">
                        ...
                        <p className="resume-card__details">
                            I am currently persuing 4th of B.tech in Computer Science
                            Engineering from GIET University
                        </p>
                    </div>
                </div>
                <div className="col-lg-6 resume-card">
                    ...
                    <div className="resume-card__body">
                        ...
                        <p className="resume-card__name">SISCASO</p>
                        <p className="resume-card__details">
                            I work as a intern in SISCASO and also completed some projects on
                            Web Development
                        </p>
                    </div>
                </div>
